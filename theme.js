...
// Обработка поля "подтип деятельности" - скрытие текста в скобках и показ в стандартной подсказке
$(document).ready(function() {
  ...
  function processCell($cell) {
    ...
    if (match) {
      ...
      // Скрываем только если текст в скобках больше 8 символов
      if (hiddenText.length > 8) {
        ...
        // Позиционирование подсказки справа снизу от курсора
        var $tip = $cell.find('.tip');
        ...
        // Если 8 или меньше символов, помечаем как обработанное, но не изменяем
        $cell.data('processed', true);
      }
    }
  }
